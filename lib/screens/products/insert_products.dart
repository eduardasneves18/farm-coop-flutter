      ...
      child: Column(
        ...
        children: [
          ...
          NumberField(
            ...
            hint: 'Preço de custo${_unidadeSelecionada != null ? ' ($_unidadeSelecionada)' : ''}',
            hintColor: const Color(0xFFD5C1A1),
            iconColor: const Color(0xFFD5C1A1),
            textColor: const Color(0xFFD5C1A1),
            borderColor: const Color(0xFF4CAF50),
          ...
          NumberField(
            ...
            hint: 'Preço de venda${_unidadeSelecionada != null ? ' ($_unidadeSelecionada)' : ''}',
            hintColor: const Color(0xFFD5C1A1),
            iconColor: const Color(0xFFD5C1A1),
            textColor: const Color(0xFFD5C1A1),
            borderColor: const Color(0xFF4CAF50),
          ...
          TextFields(
            ...
            sizeScreen: sizeScreen,
            icon: Icons.percent,
            hint: 'Margem de lucro${_unidadeSelecionada != null ? ' ($_unidadeSelecionada)' : ''}',
            hintColor: const Color(0xFFD5C1A1),
            textColor: const Color(0xFFD5C1A1),
            borderColor: const Color(0xFF4CAF50),
            cursorColor: const Color(0xFF4CAF50),
